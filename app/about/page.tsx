			...
			<main className="about-wrapper">
				<div className="about-content">
					...
					<div className="about-content__text">
						...
						<p><b>PELIZZA PICTURES</b> 是一家风格鲜明的独立创意机构，专注于定制
							化视觉与视听内容的创作与制作。 从创意到交付，我们以严谨和细致
							的态度陪伴每一个项目：艺术指导、撰写、制作、拍摄以及后期制
							作。 无论您是品牌、艺术家、媒体还是活动主办方，我们都能为您的
							愿景打造真实且富有影响力的内容</p>
						<p>تُعد <b>PELIZZA PICTURES</b> وكالة إبداعیة مستقلة ذات أسلوب ممیّز، متخصّصة في ابتكار وإنتاج محتوى بصري وسمعي-بصري مُصمَّم حسب الطلب. من الفكرة حتى التسلیم، نرافق كل مشروع بدقّة واھتمام بالتفاصیل: الإخراج الفني، الكتابة، الإنتاج، الإخراج، وما بعد الإنتاج. سواء كنتم علامة تجاریة، فنانًا، وسیلة إعلام أو منظّم فعالیة، فإننا نمنح رؤیتكم حیاةً من خلال محتوى .أصیل وفعّال ینسجم تمامًا مع تطلعاتكم</p>
					</div>
				</div>
				<Footer />
			</main>
